...
class FruitModel(banco.Model):
    ...
    def __init__(self, name_fruit, name, genus, id, family, order, carbohydrates, protein, fat, calories, sugar):
    ...
    #atualiza o objeto, não da pra modificar apenas o url_fruit
    def update_fruta(self, name, genus, id, family, order, carbohydrates, protein, fat, calories, sugar):
        self.name= name 
        self.genus= genus
        self.id= id 
        self.family= family
